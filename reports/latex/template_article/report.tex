...
\title{Zernike polynomial estimation}


% author names and affiliations

\author{gnthibault \\
Astro-FR ALZ innovation team\\
\\
}
\date{\today}
...
\begin{figure}[!h]
\centering
\includegraphics[width=0.8\columnwidth]{../../figures/666px-Zernike_polynomials_with_read-blue_cmap.png}
	\caption{21 First basis vector of zernike polynomial (excluding bias term) on the unit disk (credit: wikipedia)}
\label{fig_sim}
\end{figure}
...
Describe your first solution here. We can also cite author: \cite{Baudat_2020}
...
This research made use of POPPY, an open-source optical propagation Python package originally developed for the James Webb Space Telescope project \cite{Perrin_2012}, \cite{long2016simulating}.
